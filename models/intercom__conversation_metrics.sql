...
final as (
  select 
    ...
    round(cast(({{ dbt_utils.datediff("conversation_enhanced.conversation_created_at", "conversation_part_aggregates.first_assignment_at", 'second') }}/60) as numeric), 2) as time_to_first_assignment_minutes,
    conversation_part_aggregates.first_admin_response_at,
    round(cast(({{ dbt_utils.datediff("conversation_enhanced.conversation_created_at", "conversation_part_aggregates.first_admin_response_at", 'second') }}/60) as numeric), 2) as time_to_first_response_minutes,
    round(cast(({{ dbt_utils.datediff("conversation_part_aggregates.first_contact_reply_at", "conversation_enhanced.first_close_at", 'second') }} /60) as numeric), 2) as time_to_first_close_minutes,
    conversation_part_aggregates.first_reopen_at,
    conversation_part_aggregates.last_assignment_at,
    round(cast(({{ dbt_utils.datediff("conversation_enhanced.conversation_created_at", "conversation_part_aggregates.last_assignment_at", 'second') }} /60) as numeric), 2) as time_to_last_assignment_minutes,
    ...
    round(cast(({{ dbt_utils.datediff("conversation_part_aggregates.first_contact_reply_at", "conversation_enhanced.last_close_at", 'second') }} /60) as numeric), 2) as time_to_last_close_minutes
