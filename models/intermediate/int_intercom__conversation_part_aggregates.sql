...
final as (
  select 
    ...
    min(case when latest_conversation_part.part_type = 'comment' and latest_conversation_part.author_type = 'admin' then latest_conversation_part.created_at else null end) as first_admin_response_at,
    ...
    max(case when latest_conversation_part.part_type = 'comment' and latest_conversation_part.author_type = 'admin' then latest_conversation_part.created_at else null end) as last_admin_response_at,
