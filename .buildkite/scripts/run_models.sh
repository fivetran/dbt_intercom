...
dbt run --vars '{intercom__using_collection_history: false}' --target "$db" --select +intercom__article_enhanced
dbt test --target "$db" --vars '{intercom__using_collection_history: false}'
dbt run --vars '{intercom__using_help_center_history: false}' --target "$db" --select +intercom__article_enhanced
